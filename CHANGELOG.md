...
## [0.2.0]
### Added
- ONTOLOGY-32 Added connections create-delete-restore operations in selected graph version
- ONTOLOGY-32 Added edge create-update-delete-restore operations in selected graph version
