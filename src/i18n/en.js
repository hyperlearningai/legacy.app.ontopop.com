...
export default {
  ...
  introElementSelectionProperties: 'This allows you to choose Properties',
  introNotesType: 'This allows you to select Note type',
  introNotesElement: 'This allows you to select Element',
  introExportFilename: 'Start by choosing Filename',
  introExportImage: 'This allows you to export as image',
  introExportData: 'This allows you to export as data',
  introSearchStart: 'Start by searching. Try: road',
  introDatabaseSection: 'This allows you to navigate to a different section',
  introEditOntologyOperation: 'This allows you to choose Operation',
  introEditOntologySynonyms: 'This allows you to manage Synonyms',
  introNavigateButtons: 'This allows you to use buttons to navigate',
  introNavigateDatabase: 'This allows you to see database',
  ...
  introSynonymsElement: 'This allows you to select Element',
