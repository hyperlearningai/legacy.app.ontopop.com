...
export default {
  ...
  // intro
  next: 'Next',
  introSearchStart: 'Start by searching. Try typing: road',
  ...
  introNotesElement: 'This allows you to select an element',
  introSynonymsElement: 'This allows you to select an element',
