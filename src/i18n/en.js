...
export default {
  ...
  edgeLineStyleColor: 'Line colour',
  ...
  edgeLineStyleTextColor: 'Text colour',
  edgeLineStyleTextSize: 'Text size',
  edgeLineStyleTextAlign: 'Text alignment',
  edgeCaptionProperty: 'Edge caption property',
  ...
  // stylingNodeTextColor: 'Click on a colour to open colour palette and change colour for that option',
