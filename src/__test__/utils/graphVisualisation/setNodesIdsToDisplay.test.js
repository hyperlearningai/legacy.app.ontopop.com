...
describe('setNodesIdsToDisplay', () => {
  ...
  it('should work correctly when ALGO_TYPE_FULL and nodeIds', async () => {
  ...
  it('should work correctly when ALGO_TYPE_SEARCH_NEIGHBOURHOOD and nodeIds', async () => {
  ...
  it('should work correctly when ALGO_TYPE_NEIGHBOURHOOD and nodeIds', async () => {
  ...
  it('should work correctly when ALGO_TYPE_SHORTEST_PATH and nodeIds', async () => {
