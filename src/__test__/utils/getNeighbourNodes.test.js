import getNeighbourNodes from '../../utils/getNeighbourNodes'
...
describe('getNeighbourNodes', () => {
  ...
  it('should work correctly when separationDegree = 0', async () => {
    ...
    const result = getNeighbourNodes({
      selectedNodeId,
      separationDegree,
      classesFromApi,
      triplesPerNode
  ...
  // it('should work correctly when separationDegree = 3', () => {
  //   const separationDegree = 3
  ...
  //   expect(result).toEqual('nodesIdsToDisplay', [])
  // })
})
