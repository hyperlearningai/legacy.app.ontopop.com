...
describe('saveStyling', () => {
  ...
  it('should work correctly', async () => {
    ...
    expect(setItem).toHaveBeenCalledWith(
      'gv-styling', '{"stylingNodeShape":"circle","stylingNodeSize":25,"stylingNodeBorder":1,"stylingNodeBorderSelected":2,"stylingNodeBorderColor":"#011e41","stylingNodeBackgroundColor":"#adefd1","stylingNodeHighlightBorderColor":"#009688","stylingNodeHighlightBackgroundColor":"#abd6df","stylingNodeHoverBackgroundColor":"#f2f2f2","stylingNodeHoverBorderColor":"#607d8b","stylingNodeTextColor":"#000000","stylingNodeTextFontSize":12,"stylingNodeTextFontAlign":"center","stylingNodeCaptionProperty":"rdfsLabel","stylingNodeByProperty":[{"filterType":"equal","filterValue":"","styleType":"","styleValue":""}],"stylingEdgeLength":250,"stylingEdgeWidth":1,"stylingEdgeLineStyle":false,"stylingEdgeLineColor":"#070b11","stylingEdgeLineColorHover":"#070b11","stylingEdgeLineColorHighlight":"#9c27b0","stylingEdgeCaptionProperty":"rdfsLabel","stylingEdgeTextColor":"#070b11","stylingEdgeTextSize":12,"stylingEdgeTextAlign":"horizontal","stylingEdgeByProperty":[{"filterType":"equal","filterValue":"subClassOf","styleType":"stylingEdgeLineStyle","styleValue":true,"property":"rdfsLabel"},{"filterType":"equal","filterValue":"","styleType":"","styleValue":""}]}'
    )
